/**
 */
package treemasterview.provider;
...
/**
 * This is the item provider adapter for a {@link treemasterview.League} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LeagueItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TreemasterviewPackage.Literals.LEAGUE__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(League.class)) {
			case TreemasterviewPackage.LEAGUE__NAME:
